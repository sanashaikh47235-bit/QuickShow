  ...
  return !isLoading ? (
    <div className='relative px-6 md:px-16 lg:px-40 pt-30 md:pt-40 min-h-[80vh]'>
      ...
      {bookings.map((item, index) => (
         <div key={index} className='flex flex-col md:flex-row justify-between bg-[#2a1414]border border-[#a94444] hover:bg-[#3a1c1c] rounded-lg mt-4 p-2 max-w-3xl'>
          ...
          <div className='flex flex-col md:items-end md:text-right justify-between p-4'>
             <div className='flex items-center gap-4' >
              <p className='text-2xl fint-semibold mc-3'>{currency}{item.amount}</p>
