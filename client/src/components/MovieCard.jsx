...
const MovieCard = ({movie}) => {
  ...
  return (
    <div className='flex flex-col justify-between p-3 bg-gray-800 rounded-2xl hover:-translate-y-1 trandition duration-300 w-66'>
    ...
    <img onClick={() => {navigate(`/movies/${movie._id}`); scrollTo(0,0)}}
      ...
      <div className='flex items-center justify-between mt-4 pb-3'>
        <button onClick={() => {navigate(`/movies/${movie._id}`); scrollTo(0,0)}}
         className=' px-4 py-2 text-xs bg-red-500 hover:bg-red-700-dull transition rounded-full font-medium Cursor- pointer'>Buy Tickets</button>
